...
mod_ban_inv_events:
  ...
  events:
    on player right clicks mod_level*_item in mod_ban_inv:
      ...
      - run mod_chat_notifier def:<player.uuid>|<player.flag[amp_map].as_map.get[uuid]>|<context.item.flag[LEVEL]>|<context.item.flag[INFRACTION]>|<context.item.flag[LENGTH]>
