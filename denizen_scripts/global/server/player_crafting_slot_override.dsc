player_crafting_slots_override_events:
  ...
  data:
    items:
      ...
      - "paper[custom_model_data=300;display=<&6>Adriftus Chest;lore=<&e>Unable to use in PVP;flag=run_script:|:<list[cancel_in_minigame|player_crafting_slots_open_button]>;flag=on_drop:cancel;flag=grid_script:adriftus_chest_inventory_open;flag=no_drop_on_death:true]"
