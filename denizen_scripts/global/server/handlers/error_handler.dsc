    ...
    # % ██ [ Cache the Information Needed  ] ██
      ...
      - if <context.script.name||Invalid> != invalid:
        - if <context.script.filename.after[/plugins/Denizen/scripts/].starts_with[global]>:
          - define File_Location https://github.com/AuroraInteractive/network-script-data/tree/master/denizen_scripts/global/<context.script.filename.after[/scripts/global/server/]>
        - else:
          - define File_Location https://github.com/AuroraInteractive/network-script-data/tree/master/denizen_scripts/<bungee.server>/<context.script.filename.after[/plugins/Denizen/scripts/]||Invalid>
