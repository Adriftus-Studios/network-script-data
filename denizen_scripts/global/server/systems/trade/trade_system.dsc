...
trade_open:
  ...
  script:
    ...
    - inventory set slot:<[inv_script].data_key[data.item_slots.player_2_head]> o:player_head[skull_skin=<[player2].skull_skin>;custom_model_data=101;flag=uuid:<[player2].uuid>;display=<&font[adriftus:overlay]><&chr[F90F]>;lore=<element[<&sp>].repeat_as_list[300]>] d:trade_<[player1].uuid>/<[player2].uuid>
