Skin_Command:
    ...
    tab complete:
        ...
        - if !<player.has_flag[Behrry.Essentials.SavedSkins]>:
            - stop
        - define SavedSkins <player.flag[Behrry.Essentials.SavedSkins].parse[before[/]]>

        - if <context.args.size> == 1 && <[Arg2].contains[<context.args.get[1]>]> && <[Whitespace]> && <player.has_flag[Behrry.Essentials.SavedSkins]>:
            - determine <[SavedSkins]>

        - else if <context.args.size> == 2 && <[Arg2].contains[<context.args.get[1]>]> && !<[Whitespace]> && <player.has_flag[Behrry.Essentials.SavedSkins]>:
    ...
    # @ ██ [  Check for args ] ██
        ...
        - choose <[SkinArg]>:
            ...
            - case Set:
                ...
                - if <player.has_flag[Behrry.Essentials.SavedSkins]>:
                    - if <player.flag[Behrry.Essentials.SavedSkins].parse[before[/]].contains[<[SkinName]>]>:
                        - define SkinBlob:<player.flag[Behrry.Essentials.SavedSkins].map_get[<[SkinName]>]>
            ...
            - case Save:
                ...
                - if <context.args.size> == 2:
                    - adjust <player> skin:<[SkinName]>
                    - flag player Behrry.Essentials.SavedSkins:->:<[SkinName]>/<player.skin_blob>
                ...
                - flag player Behrry.Essentials.SavedSkins:->:<[SkinName]>/<[SkinBlob]>
                - narrate "<proc[Colorize].context[Skin saved:|green]> <&e><[SkinName]>"
            ...
            - case List:
                ...
                - narrate "<&a><player.flag[Behrry.Essentials.SavedSkins].parse[before[/]].separated_by[<&e>, <&a>]>"
            - case Rename:
                ...
                - if <player.has_flag[Behrry.Essentials.SavedSkins]>:
                    - if !<player.flag[Behrry.Essentials.SavedSkins].parse[before[/]].contains[<[OldSkinName]>]>:
                        - narrate "<proc[Colorize].context[You do not have this skin saved:|red]> <&e><[OldSkinName]>"
                        - stop
                - define NewSkinName <context.args.get[3]>
                - if <player.has_flag[Behrry.Essentials.SavedSkins]>:
                    - if <player.flag[Behrry.Essentials.SavedSkins].parse[before[/]].contains[<[NewSkinName]>]>:
                ...
                - flag player Behrry.Essentials.SavedSkins:->:<[NewSkinName]>/<[SkinBlob]>
                - flag player Behrry.Essentials.SavedSkins:<-:<[OldSkinName]>/<[SkinBlob]>
