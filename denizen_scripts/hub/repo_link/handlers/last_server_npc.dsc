last_server_npc:
  ...
  actions:
    ...
    on enter proximity:
    # TEMPORARY FORCE
    - yaml id:global.player.<player.uuid> set adriftus.last_server:Herocraft
    ...
    - else:
      - fakespawn "armor_stand[custom_name=<&6>Welcome to Adriftus;custom_name_visible=true;marker=true;visible=false]" <npc.location.above[2]> duration:10h players:<player> save:ent1
      - fakespawn "armor_stand[custom_name=<&b>Check out our tutorial!;custom_name_visible=true;marker=true;visible=false]" <npc.location.above[1.7]> duration:10h players:<player> save:ent2
