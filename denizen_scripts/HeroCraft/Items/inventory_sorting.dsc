inventory_sorting_events:
  ...
  events:
    ...
    - if <context.clicked_inventory.exists> && <context.clicked_inventory.id_holder.object_type> == Location:
      ...
      - adjust <context.clicked_inventory> contents:<context.clicked_inventory.list_contents.exclude[<item[air]>].sort_by_value[material.name]>inventory_sorting_events: