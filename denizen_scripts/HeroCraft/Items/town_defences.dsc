...
town_defence_item:
  ...
  recipes:
    1:
      type: shaped
      input:
        - compressed_amethyst_block|double_compressed_obsidian|compressed_amethyst_block
...
town_defence_attack:
  ...
  script:
    ...
    - hurt <[target]> <[entity].location.town.flag[active_defences].size.mul[2].max[1].min[11]> cause:CUSTOM
