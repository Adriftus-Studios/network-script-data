...
crystallizing_enchant_handler:
  ...
  debug: false
  events:
    on player breaks sandstone|stone|red_sandstone|andesite|granite|diorite|deepslate|endstone|tuff|dripstone_block|calcite with:item_enchanted:crystallizing:
      - ratelimit <player> 2t
