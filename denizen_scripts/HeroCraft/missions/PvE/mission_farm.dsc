...
mission_farm_events:
  ...
  debug: false
  events:
    on player breaks pumpkin|melon|wheat|potatoes|carrots|beetroots|cocoa|sweet_berry_bush|nether_wart flagged:missions.active.farm bukkit_priority:HIGHEST:
