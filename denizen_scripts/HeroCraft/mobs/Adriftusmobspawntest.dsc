...
## For debugging, modify the server's valid prefix/suffix flags
    ...
    - adjust <context.entity> "custom_name:<script[rarity_data_table].data_key[<[rarity]>.color].parsed><[prefix_list].space_separated.to_titlecase> <context.entity.custom_name.if_null[<context.entity.entity_type.replace[_].with[<&sp>].to_titlecase>]> <[sufix_list].insert[The].at[1].space_separated.to_titlecase.if_null[]>"
