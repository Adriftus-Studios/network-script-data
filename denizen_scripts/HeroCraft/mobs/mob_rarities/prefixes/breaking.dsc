custom_mob_prefix_breaking:
  ...
  events:
    after entity_flagged:breaking damages player:
        ...
        - narrate "<context.damager.custom_name.if_null[<context.entity.entity_type.replace[_].with[ ].to_titlecase>]><&r> disabled your <player.item_in_hand.display.if_null[<player.item_in_hand.material.replace_text[_].with[ ].to_titlecase>]>!"
