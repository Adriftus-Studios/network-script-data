...
item_skin_system_update:
  ...
  script:
    ...
    - wait 1t
    - give <[inventory].slot[52]> if:<[inventory].slot[52].material.name.equals[air].not>
    ...
    - if <[type]> == armor:
      - foreach <[cosmetics].get[<[start]>].to[<[end]>].if_null[<list>]> as:skin_name:
        ...
        - else:
          - define new_item <[item].with[material=leather_<[material].after[_]>]>
...
item_skins_kit_armorstand:
  ...
  script:
    ...
    - define head leather_helmet[color=<[map].get[color].parsed>;custom_model_data=<[map].get[CMD]>]
    - define legs leather_leggings[color=<[map].get[color].parsed>;custom_model_data=<[map].get[CMD]>]
    - define boots leather_boots[color=<[map].get[color].parsed>;custom_model_data=<[map].get[CMD]>]
    - define chest leather_chestplate[color=<[map].get[color].parsed>;custom_model_data=<[map].get[CMD]>]
