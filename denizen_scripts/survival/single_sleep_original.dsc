single_sleep_script:
  ...
  events:
    on player enters bed:
      ...
      - define increment <world[mainland].time.-[24000].abs./[<script[single_sleep_script].yaml_key[time_change_duration_in_ticks]>].round_up>
      - repeat <script[single_sleep_script].yaml_key[time_change_duration_in_ticks]>:
