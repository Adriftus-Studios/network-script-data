...
market_command:
  ...
  script:
    - if <server.flag[market_open]>:
      - inventory open d:market_system_main_GUI player:<server.match_player[<context.args.get[1]>]>
    - else:
...
market_system_main_GUI:
  ...
  procedural items:
    - foreach <script[market_system_data].list_keys[categories]> as:category:
      ...
      - define lore <script[market_system_data].yaml_key[categories.<[category]>.lore].parse_color>
      - define material <script[market_system_data].yaml_key[categories.<[category]>.material]>
      - define CMD <script[market_system_data].yaml_key[categories.<[category]>.CMD]>
  ...
  events:
    on player clicks item in market_system_category_GUI:
      ...
      - if <context.item.has_nbt[buy]>:
        ...
        - define item <[inventory].slot[<script[market_system_category_GUI].yaml_key[custom_slots_map.buy_sell_item]>].nbt[item]>
...
market_system_get_price_of_multiple:
  ...
  script:
    ...
    - if <[buy_or_sell]> == sell:
      - define current_value <[current_value].-[<script[market_system_data].yaml_key[settings.sell_buy_difference]>]>
    ## OLD
    #- repeat <[amount]>:
    #  - define list:|:<[current_value]>
    #  - define current_value:+:<script[market_system_data].yaml_key[settings.adjustment_amount]>
    #- determine <[list].sum>
...
market_system_category_set_buy_sell_items:
  type: task
  script:
    - define slot <script[market_system_category_GUI].yaml_key[custom_slots_map.buy_sell_item]>
    - define buy_price <yaml[current_market].read[items.<[item]>.value]>
    - define sell_price <[buy_price].-[<script[market_system_data].yaml_key[settings.sell_buy_difference]>]>
    ...
    - if <[amount_in_inventory]> > 1:
      ...
      - define slot <script[market_system_category_GUI].yaml_key[custom_slots_map.sell.all]>
    ...
    - if <[max_stack]> > 1:
      ...
      - define slot <script[market_system_category_GUI].yaml_key[custom_slots_map.sell.stack]>
      ...
      - define slot <script[market_system_category_GUI].yaml_key[custom_slots_map.buy.stack]>
    ...
    - if <[max_stack]> > 1 && <[max_stack].mod[2]> == 0:
      ...
      - define slot <script[market_system_category_GUI].yaml_key[custom_slots_map.sell.half_stack]>
      ...
      - define slot <script[market_system_category_GUI].yaml_key[custom_slots_map.buy.half_stack]>
    ...
    # ONLY ONE
    - define slot <script[market_system_category_GUI].yaml_key[custom_slots_map.sell.one]>
    ...
    - define slot <script[market_system_category_GUI].yaml_key[custom_slots_map.buy.one]>
...
market_system_category_set_market_next_page:
  type: task
  script:
    - if <yaml[market].list_keys[categories.<[category]>].size> > <script[market_system_category_GUI].yaml_key[custom_slots_map.market_items].as_list.size>:
      - inventory set slot:<script[market_system_category_GUI].yaml_key[custom_slots_map.next_page]> d:<[inventory]> o:<item[market_system_category_next_page_button].with[nbt=action/next_page]>
    - else if <[inventory].slot[<script[market_system_category_GUI].yaml_key[custom_slots_map.next_page]>].script.name||null> == market_system_category_next_page_button:
      - inventory set slot:<script[market_system_category_GUI].yaml_key[custom_slots_map.next_page]> d:<[inventory]> o:<script[market_system_category_GUI].yaml_key[definitions.filler].parsed>

market_system_category_set_market_previous_page:
  type: task
  script:
    - if <[inventory].slot[<script[market_system_category_GUI].yaml_key[custom_slots_map.hidden_marker]>].nbt[page]> > 1:
      - inventory set slot:<script[market_system_category_GUI].yaml_key[custom_slots_map.previous_page]> d:<[inventory]> o:<item[market_system_category_previous_page_button].with[nbt=action/previous_page]>
    - else if <[inventory].slot[<script[market_system_category_GUI].yaml_key[custom_slots_map.previous_page]>].script.name||null> == market_system_category_previous_page_button:
      - inventory set slot:<script[market_system_category_GUI].yaml_key[custom_slots_map.previous_page]> d:<[inventory]> o:<script[market_system_category_GUI].yaml_key[definitions.filler].parsed>

market_system_category_set_market_items:
  type: task
  script:
    - inventory set slot:<script[market_system_category_GUI].yaml_key[custom_slots_map.hidden_marker]> d:<[inventory]> o:<script[market_system_category_GUI].yaml_key[definitions.filler].parsed.with[nbt=page/<[page]>|category/<[category]>]>
    - foreach <script[market_system_category_GUI].yaml_key[custom_slots_map.market_items]> as:slot:
      - define items_per_page <script[market_system_category_GUI].yaml_key[custom_slots_map.market_items].as_list.size>
...
market_system_category_set_player_head:
  ...
  script:
    ...
    - inventory set slot:<script[market_system_category_GUI].yaml_key[custom_slots_map.player_info]> d:<[inventory]> o:<[player_head]>
...
market_system_yaml_builder:
  ...
  make_market_data:
    ...
    - foreach <script[market_system_data].list_keys[items]> as:item:
      - if <yaml[current_market].yaml_key[items.<[item]>.value]||null> == null:
        - yaml id:current_market set items.<[item]>.value:<script[market_system_data].yaml_key[items.<[item]>.minimum_value]>
  build_yaml_data:
    - yaml id:market create
    - foreach <script[market_system_data].list_keys[items]> as:item:
      - define category <script[market_system_data].yaml_key[items.<[item]>.category]>
...
market_system_transfer_yaml_hourly:
  ...
  script:
    - foreach <script[market_system_data].list_keys[items]> as:item:
      - define min_value <script[market_system_data].yaml_key[items.<[item]>.minimum_value]>
