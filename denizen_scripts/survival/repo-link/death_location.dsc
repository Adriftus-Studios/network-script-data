player_death_event:
  ...
  events:
    on player death:
      - flag player player_death_cause:<context.cause>
      - flag player player_death_location:<player.location>
      - if <player.world.name> == mainland:
      ...
      - else if <player.world.name> == mainland_nether:
      ...
      - else if <player.world.name> == mainland_the_end:
