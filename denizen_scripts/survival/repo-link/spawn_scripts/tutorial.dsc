...
tutorial_start:
  ...
  script:
    ...
    - fakespawn armor_stand[custom_name_visible=true;visible=false;custom_name=<script[tutorial_data].data_key[start.start_button]>] <location[tutorial_start_hologram].sub[0,<script[tutorial_data].data_key[start.hologram].size.+[2].*0.25]>,0]>
    - fakespawn armor_stand[custom_name_visible=true;visible=false;custom_name=<script[tutorial_data].data_key[start.stop_button]>] <location[tutorial_start_hologram].sub[0,<script[tutorial_data].data_key[start.hologram].size.+[2].*0.25]>,0]>
