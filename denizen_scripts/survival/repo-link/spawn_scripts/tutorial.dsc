...
tutorial_start:
  ...
  script:
    ...
    - fakespawn armor_stand[custom_name_visible=true;visible=false;marker=true;custom_name=<&a><&b><script[tutorial_data].data_key[start.start_button].parse_color>] <location[tutorial_start_hologram].right[1.5].sub[0,<script[tutorial_data].data_key[start.hologram].size.*[0.25]>,0]> duration:10m
    - fakespawn armor_stand[visible=false;custom_name=ContinueTutorial] <location[tutorial_start_hologram].right[1.5].sub[0,<script[tutorial_data].data_key[start.hologram].size.+[4].*[0.25]>,0]> duration:10m
    - fakespawn armor_stand[custom_name_visible=true;visible=false;marker=true;custom_name=<&b><&a><script[tutorial_data].data_key[start.skip_button].parse_color>] <location[tutorial_start_hologram].left[1.5].sub[0,<script[tutorial_data].data_key[start.hologram].size.*[0.25]>,0]> duration:10m
    - fakespawn armor_stand[visible=false;custom_name=SkipTutorial] <location[tutorial_start_hologram].left[1.5].sub[0,<script[tutorial_data].data_key[start.hologram].size.+[4].*[0.25]>,0]> duration:10m
  ...
  script:
    ...
    - if <location[tutorial_<[stage]>]||null> != null:
      ...
      - if <script[tutorial_data].data_key[<[stage].+[1]>]||null> == null:
        - fakespawn armor_stand[custom_name_visible=true;marker=true;visible=false;custom_name=<script[tutorial_data].data_key[complete_button].parse_color>] <location[tutorial_<[stage]>].above[1]> duration:10m
      - else:
        - fakespawn armor_stand[custom_name_visible=true;marker=true;visible=false;custom_name=<script[tutorial_data].data_key[continue_button].parse_color>] <location[tutorial_<[stage]>].above[1]> duration:10m
