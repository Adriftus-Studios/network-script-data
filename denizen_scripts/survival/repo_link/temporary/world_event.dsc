...
world_event_progress_inventory_open:
  ...
  script:
    ...
    - repeat 6:
      - give "barrier[display_name=<&a>Week <[value].add[2]>;lore=<&b>Release Date<&co>|<&e><time[2020/12/11_02:20:31:123_-07:00].add[<[value].mul[7]>d].format[MM/dd/YYYY]>]" to:<[inventory]>
