...
survivalistInventory:
    ...
    definitions:
        ...
        backpack_36: <item[Backpack_36].with[flag=item:Backpack_36;lore=<&e>Slots:<&sp><&a>36|<&a>Buy<&sp>Price:<&sp><&e><script[survivalistData].data_key[Items.Backpack_36.Prices].before[/]>|<&c>Sell<&sp>Price:<&sp><script[survivalistData].data_key[Items.Backpack_36.Prices].after[/]>]>
        backpack_45: <item[Backpack_45].with[flag=item:Backpack_45;lore=<&e>Slots:<&sp><&a>45|<&a>Buy<&sp>Price:<&sp><&e><script[survivalistData].data_key[Items.Backpack_45.Prices].before[/]>|<&c>Sell<&sp>Price:<&sp><script[survivalistData].data_key[Items.Backpack_45.Prices].after[/]>]>
    ...
    events:
        ...
        - if <context.item.has_flag[action]>:
            - choose <context.item.flag[action]>:
                - case buy:
                    - if <player.money> >= <script[survivalistData].data_key[Items.<context.item.flag[key]>.Prices].before[/]>:
                        - playsound <player> sound:UI_BUTTON_CLICK volume:0.6 pitch:1.4
                        - give <script[survivalistData].parsed_key[Items.<context.item.flag[key]>.Item]>
                        - money take quantity:<script[survivalistData].data_key[Items.<context.item.flag[key]>.Prices].before[/]>
                ...
                - case sell:
                    ...
                    # - if <player.inventory.list_contents.filter[has_flag[backpack_slots]].filter[flag[backpack_slots].is[==].to[<context.item.flag[key].after[Backpack]>]].size||0> > 0 || <player.inventory.contains[<script[survivalistData].parsed_key[Items.<context.item.flag[key]>.Item]>]>:
                        - playsound <player> sound:UI_BUTTON_CLICK volume:0.6 pitch:1.4
                        - take slot:<player.inventory.find.scriptname[<context.item.flag[key]>]>
                        - money give quantity:<script[survivalistData].data_key[Items.<context.item.flag[key]>.Prices].after[/]>
