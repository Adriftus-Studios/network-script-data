Error_Response_Webhook:
    ...
    # % ██ [ Create Issue Template Link ] ██
        ...
        - define Body_Text "<&lt>!--- Remove any sections that don't apply or you have inadequate information for. ---<&gt><&nl><&lt>!--- Add any other context about the problem below. ---<&gt><&nl><&nl>"
