status_command_create:
  ...
  debug: true
  script:
    - ~discordcommand id:a_bot create name:status "Description:Shows the status of a server, or servers" group:626078288556851230
  ...
  events:
    on discord slash command name:status:
      - definemap embed_data:
          ...
          description: i dont know what you want from me
